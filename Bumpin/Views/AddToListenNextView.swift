...
struct AddToListenNextView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle("Add to Listen Next")
    ...
    private var initialStateView: some View {
        VStack(spacing: 20) {
            ...
            VStack(spacing: 8) {
                ...
                Text("Find \(selectedFilter.displayName.lowercased()) to add to your Listen Next list")
...
// MARK: - Add to Listen Next Result Row
struct AddToListenNextResultRow: View {
