...
exports.runTrendingUpdateOnce = runTrendingUpdateOnce;
...
function subredditsFor(category) {
    switch (category) {
        case 'trending':
...
function generateFallbackTopics(category) {
...
async function runTrendingUpdateOnce() {
